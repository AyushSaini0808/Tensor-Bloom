    ...
    return (
        <div className={"h-screen w-screen gradient-bg"}>
          ...
          Solve tailored questions, strengthen your fundamentals, and advance your ML expertise step by step.
                ...
                {session?.user ? null : ( // Use optional chaining for session
                    <button
                        onClick={() => signInAction()}
                        className={
                            "text-2xl bg-gray-950 border-gray-700 mr-3 w-[20%] my-20 place-self-center text-slate-200 font-bold px-5 py-2 border-2 rounded-lg border-blue-500 hover:text-black font-jetbrains-mono hover:bg-white/80 hover:text-black transition duration-300 ease-in-out"
                        }
                    >
                        Login
                    </button>
                ...
                <div className={"grid grid-cols-4 gap-20 grid-rows-2"}>
                    <div className={"col-span-2"}>
                        ...
                        <p className={"text-[#afb0b6] text-base font-generalsans"}>
                            ...
                            Artificial Intelligence (AI) through an engaging, challenge-driven approach. We believe that learning ML
                            is not just about theory but about growing through challenges and hands-on practice, one tensor at a time.
                        </p>
                    </div>
                    <div className={"col-span-2"}>
                        <h2 className={"text-3xl font-semibold mb-2 text-white font-jetbrains-mono"}>Our Mission</h2>
                        <p className={"text-[#afb0b6] text-base font-generalsans"}>
                            At Tensor Bloom, we focus on hands-on problem-solving and continuous growth. Our mission is to provide an
                            inclusive platform where learners and experts strengthen fundamentals, tackle real-world ML challenges,
